            ...
            <table className="premium-table">
              ...
              <tbody>
                {alerts.length > 0 ? alerts.map((alert, idx) => {
                  ...
                  return (
                    <tr key={idx} style={{ transition: 'background 0.2s' }} className="hover-row">
                      ...
                      <td style={{ padding: '16px' }}>
                         ...
                         <div style={{ fontSize: '9px', color: 'var(--text-muted)', textTransform: 'uppercase', marginTop: '2px' }}>Hardware Sensor V4</div>
                      </td>
