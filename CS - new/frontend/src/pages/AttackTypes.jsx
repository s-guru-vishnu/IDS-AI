    ...
    <div className="animate-in">
      {!urlType ? (
        <>
          ...
          <div className="attack-type-grid" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(320px, 1fr))', gap: '24px' }}>
            {types.map((t, i) => {
                ...
                <div key={i} className="dash-card dash-card-mesh" style={{ cursor: 'pointer', borderLeft: `4px solid ${theme.color}` }} onClick={() => navigate(`/attack-types/${t.attack_type}`)}>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ fontSize: '36px', fontWeight: '800', color: 'var(--text-primary)', letterSpacing: '-1.5px' }}>{t.count}</div>
                    </div>
                  </div>
                  <div style={{ marginTop: '24px', padding: '16px', background: 'var(--bg-surface)', borderRadius: '12px', display: 'flex', justifyContent: 'space-between' }}>
                      <div>
        ...
        <>
          ...
          <div className="dashboard-grid">
              ...
              <div className="side-column">
                  <div className="dash-card">
                      <h3 style={{ fontSize: '11px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '2px', marginBottom: '24px' }}>Statistical Pulse</h3>
                      <div className="risk-meter-container">
                          <div className="risk-circle" style={{ width: '130px', height: '130px' }}>
                      ...
                      <div style={{ marginTop: '32px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                          <div style={{ background: 'var(--bg-surface)', padding: '16px', borderRadius: '12px' }}>
                              ...
                              <div style={{ fontSize: '24px', fontWeight: '800' }}>{drilldown?.stats?.total}</div>
                          </div>
